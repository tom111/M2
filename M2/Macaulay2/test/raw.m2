...
assert( ((),()) == pairs 0_R )
assert( try ( leadCoefficient 0_R ; false ) else true )  -- should give error message
...
assert( toString vv == "x<0>+y<1>+z<2>" )
...
show "rawMonomials((1,-2),f)"
show "rawCoefficients((1,-2),(0,1),f)"
