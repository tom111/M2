...
idealizer2 (Ideal, RingElement) := o -> (J, f) -> (
     ...
     if ideal(idJ) == ideal(f) then (
	  ...
	  --newVars := reverse apply(n, i -> o.Variable_(o.Index2+i));
	  -- o.Variable_(o.Index2)..o.Variable_(o.Index2+n-1)
...
--assert(icFractions2 R == substitute(matrix {{y*z/x^2, x, y, z}},frac R))
--assert(icFractions2 R == substitute(matrix {{42 * y*z/x^2, x, y, z}},frac R))
///
