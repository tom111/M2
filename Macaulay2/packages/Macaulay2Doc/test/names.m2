...
assert( (toString EliminationOrder) === "EliminationOrder" )
...
assert( (toString F) === "F" )
assert( (toString F4) === "F4" )
assert( (toString Fano) === "Fano" )
assert( (toString Faugere) === "Faugere" )
...
assert( (toString NonLinear) === "NonLinear" )
...
assert( (toString applicationDirectorySuffix) === "applicationDirectorySuffix" )
...
assert( (toString b) === "b" )
assert( (toString backtrace) === "true" )
...
assert( (toString printWidth) === "157" )
...
assert( (toString recursionLimit) === "300" )
...
assert( (toString scriptCommandLine) === "{}" )
...
assert( (toString stopIfError) === "false" )
